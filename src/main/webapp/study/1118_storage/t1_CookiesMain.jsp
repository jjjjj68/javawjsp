...
<div class = "container">
	...
	<div class="row">
		...
		<div class="col"><a href="t1_CookiesCkeck.jsp" class="btn btn-success form-control">쿠키 확인</a></div>
		<div class="col"><a href="t1_CookiesDelete.jsp" class="btn btn-success form-control">쿠키 삭제</a></div>
		<div class="col"><a href="t1_CookiesDeletePwd.jsp" class="btn btn-danger form-control">비밀번호 삭제</a></div>
	</div>
</div>
<p><br/></p>
</body>
