...
<div class = "container">
	...
	<table class="table table-hover">
		...
		<tr><td clospan="6" class="m-0 p-0"></td></tr>
	</table>
	<p>전체 출력 건수 : <font color="blue"><b>${cnt0}건</b></font></p>
	<hr/>
	<pre>
		 <h4>등록된 회원중 홀수번째 가입만 회원만 출력하시오!</h4>
		 <h2>회원 전체 리스트2</h2>
		 <table class="table table-hover">
			<tr>
				<th>번호</th>
	...
	<p>전체 출력 건수 : <font color="blue"><b>${cnt}건</b></font></p>
	<hr/>
