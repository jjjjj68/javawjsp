		...
		<script>
			...
			function fCheck(idx) {
				...
				if(pwd.trim() == "") {
					...
					/* document.getElementById("demo").innerHTML = "<font color='red'><b>콘솔창을 확인하세요..</b></font><br/><a href='${ctp}/pass.st' class='btn btn-warning'>돌아가기</a>";
...
<div class = "container">
	...
	<form name="myform" method="post">
		<table class="table table-bordered">
			<tr>
				<td>
					<p>아이디 : <input type="text" name="mid" value="hkd1234" autofocus class="form-control"/></p>
