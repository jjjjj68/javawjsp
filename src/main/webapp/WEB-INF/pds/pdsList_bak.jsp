...
<head>
  ...
  <script>
  	...
  	function modalView(title,nickName,mid,part,fName,fSName,fDate,fSize,downNum){
  	...
  	// 선택한 항목의 자료 삭제하기....(prompt창을 통하여 비민번호를 입력받아서 처리)
...
<!-- The Modal(폼태그로 비밀번호 처리하기 하기 위한 모달.) -->
